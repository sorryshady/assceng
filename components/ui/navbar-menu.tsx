  ...
  return (
    <div onMouseEnter={() => setActive(item)} className="relative">
      <motion.p
        ...
        className="cursor-pointer hover:text-primary flex items-center justify-center gap-1"
      >
        {item}
        <span>
          <ChevronDown size={12} />
...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full border border-transparent dark:bg-black dark:border-white/[0.2] bg-transparent shadow-input flex justify-center items-center space-x-5 px-8 py-6 "
    >
      {children}
    </nav>
  );
